...
class HiveMeterRepository implements MeterRepository {
  ...
  final List<Meter> _mockMeters = [
    Meter(
      id: 'MET-8821-X9',
      customerName: 'Robert Jensen',
      address: 'Kumasi, West Lands Avenue',
      telephone: '+233 24 123 4567',
      tariffClass: 'Residential E01',
      gpsCoordinates: '6.6666, -1.6163',
      ...
      status: MeterStatus.scheduled,
      installationDate: DateTime(2023, 9, 14),
      dateApprehended: DateTime(2023, 9, 14),
      offenseType: 'Meter Bypass Detected',
      debtAmount: 1245.0,
      isSynced: true,
    ),
    Meter(
